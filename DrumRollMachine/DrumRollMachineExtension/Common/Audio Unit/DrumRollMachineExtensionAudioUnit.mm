//
//  DrumRollMachineExtensionAudioUnit.mm
//  DrumRollMachineExtension
//
//  Created by Austin Kang on 3/31/23.
//

#import "DrumRollMachineExtensionAudioUnit.h"

#import <AVFoundation/AVFoundation.h>
#import <CoreAudioKit/AUViewController.h>
#import <CoreMIDI/CoreMIDI.h>

#import "DrumRollMachineExtensionAUProcessHelper.hpp"
#import "DrumRollMachineExtensionDSPKernel.hpp"


// Define parameter addresses.

@interface DrumRollMachineExtensionAudioUnit ()
...
@implementation DrumRollMachineExtensionAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    DrumRollMachineExtensionDSPKernel _kernel;
...
- (void)setupParameterCallbacks {
    ...
    __block DrumRollMachineExtensionDSPKernel *kernel = &_kernel;
