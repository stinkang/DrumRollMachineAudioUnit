...
private let log = Logger(subsystem: "BeatMachine.DrumRollMachineExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<DrumRollMachineExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try DrumRollMachineExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? DrumRollMachineExtensionAudioUnit else {
            log.error("Unable to create DrumRollMachineExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(DrumRollMachineExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = DrumRollMachineExtensionMainView(parameterTree: observableParameterTree)
