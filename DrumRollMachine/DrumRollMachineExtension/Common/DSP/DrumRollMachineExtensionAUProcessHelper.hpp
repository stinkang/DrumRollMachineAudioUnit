//
//  DrumRollMachineExtensionAUProcessHelper.hpp
...
#include <vector>
#include "DrumRollMachineExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(DrumRollMachineExtensionDSPKernel& kernel)
    : mKernel{kernel} {}
...
private:
    DrumRollMachineExtensionDSPKernel& mKernel;
};
